...
namespace Preda_Marcela_Lab8.Models
{
    public class BookCategoriesPageModel: PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Preda_Marcela_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Preda_Marcela_Lab8Context context,
